<div class="about_area" id="about">
  <div class="about_main container">
    ...
    <div class="about_para">
      <p class="text-justify">Even with the involvement of technology in many sectors, property is still operating with the same
...
solve this problem, we made a computerized system so that anyone can easily find their desired type of house anywhere.</p>
    </div>
  </div>
</div>
